...
/*
	...
	var/obj/item/melee/cultblade/cultblade/SB = loc
...
/spell/soulblade/cast_check(skipcharge = 0,mob/user = usr)
	var/obj/item/melee/cultblade/cultblade/SB = user.loc
...
/spell/soulblade/after_cast(list/targets)
	..()
	var/obj/item/melee/cultblade/cultblade/SB = holder.loc
...
/datum/action/cooldown/blade_spin
	name = "Spin Slash"
	check_flags = NONE
...
/spell/soulblade/blade_perforate/cast(var/list/targets, var/mob/user)
	..()
	var/obj/item/melee/cultblade/cultblade/blade = user.loc
...
/client/MouseDrop(src_object,over_object,src_location,over_location,src_control,over_control,params)
	if(!mob || !isshade(mob) || !istype(mob.loc,/obj/item/melee/cultblade/cultblade))
		return ..()
	var/obj/item/melee/cultblade/cultblade/SB = mob.loc
