...
/obj/item/projectile/soulbullet
	...
	mouse_opacity = TRUE
	candink = FALSE
	var/turf/secondary_target
	var/obj/item/melee/cultblade/cultblade/blade
	var/mob/living/simple_animal/shade/shade
	var/redirected
	var/leave_shadows = -1
	var/matrix/shadow_matrix
...
/obj/item/projectile/soulbullet/fire(proj_target = original)
...
/obj/item/projectile/soulbullet/bresenham_step(distA, distB, dA, dB)
...
/obj/item/projectile/soulbullet/Cross(atom/movable/mover, turf/target, height = 1.5, air_group = 0)
	if(istype(mover, /obj/item/projectile))
		if(prob(30))//less likely to be hit when perforating
			return FALSE
	return ..()

/obj/item/projectile/soulbullet/attackby(obj/item/I, mob/user)
	if (blade)
...
/obj/item/projectile/soulbullet/bullet_act(obj/item/projectile/P)
	if(blade)
