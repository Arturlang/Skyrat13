...
/obj/machinery/station_map
	...
	var/original_zLevel = TRUE	//zLevel on which the station map was initialized.
	var/bogus = FALSE			//set to 1 when you initialize the station map on a zLevel that doesn't have its own icon formatted for use by station holomaps.
...
/obj/item/wallframe/crowbar_act(mob/user, obj/item/I)
