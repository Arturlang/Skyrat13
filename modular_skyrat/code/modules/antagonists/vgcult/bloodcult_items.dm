...
/obj/item/weapon/melee/soulblade/throw_at(atom/targ, range, speed, mob/thrower, spin=TRUE, diagonals_first = FALSE, var/datum/callback/callback)
...
/obj/item/weapon/melee/soulblade/hitby(atom/movable/AM, hitpush, throwingdatum)
	. = ..()
	if(.)
		return
